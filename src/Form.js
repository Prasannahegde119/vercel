...
//   const [showPersons, setShowPersons] = useState(false); // State to control when to show persons
...
//           />
//         </div>
//         <button type="submit" className="btn show-btn" onClick={handleSubmit}>Add</button>
//         <button type="submit" className="btn show-btn" 
//          onClick={() => setShowPersons(true)}
        
//         >Show</button>
//         <div className="input-group">
//           <label htmlFor="yourPhoneNumber" className="stylish-label">Your Phone Number Is</label>
//           <textarea
//            readOnly
//             id="yourPhoneNumber"
...
//             persons.length > 0
//               ? persons.map(
//                   (person) => `${person.name}: ${person.phoneNumber}`
//                 ).join("\n")
//               : "No data available"
//           }
//           ></textarea>
